...
String employee_status = (String)session.getAttribute("employee_status");
%>
...
<table class="table">
  <tr>
    ...
    <td><form id="form1" name="form1" method="post" action="ReportBug">
      <table class="table">
        <tr>
          <td >Below are the Employee Details</td>
          </tr>
          <%
	...
	%>
        ...
        <tr>
          <td valign="top">Employee Status     :<%= employee_status %></td>
        </tr>
        <tr>
