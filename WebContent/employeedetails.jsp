...
<table class="table">
  <tr>
	...
	out.print("<div align=center class=errortext>Enter correct Employee Number</div>");
	%>
      <tr>
    ...
    <td><form id="form1" name="form1" method="post" action="EmployeeDetails">
      <table class="table">
        <tr>
          <td >Display Employee Details</td>
          </tr>
        <tr>
